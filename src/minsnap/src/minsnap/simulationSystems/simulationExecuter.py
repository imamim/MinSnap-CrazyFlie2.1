...
if __name__ == "__main__":
    env_class = Environment() #For Environment generation, use 2 drones data but compute 1 drones message!
    ...
    while not rospy.is_shutdown():
        ...
        cmd_msg = manager.command.allcommands[0]
        virtual_drone = obs[str(0)]
